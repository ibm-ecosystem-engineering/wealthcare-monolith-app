...
@WebServlet(name = "CusFinancialPlanListServlet", urlPatterns = {"/CusFinancialPlanList"})
public class CusFinancialPlanListServlet extends HttpServlet {
